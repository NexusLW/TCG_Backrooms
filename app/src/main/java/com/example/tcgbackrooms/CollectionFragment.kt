...
class CollectionFragment : Fragment() {
    ...
    //el orden en que queremos que aparezcan las secciones
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //grid with 3 columns, but headers need to span all 3 columns
        //rejilla de 3 columnas, pero las cabeceras deben ocupar las 3 columnas
